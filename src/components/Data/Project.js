...
export const projectList = [
    {
        ...
        language: ['HTML', 'Javascript', 'CSS', 'C#'],
...

    {
        ...
        language: ['HTML', 'Javascript', 'CSS', 'vue', 'node'],
        ownership: 'Personal',
...

    {
        ...
        description: 'A Human resource application that automates employee management processes for the West African Examination Council (WAEC) Nigeria. Key features include: Leave and Absence, Employee Data Management, Pension and Benefits management, Post Recruitment, Employee Self Service, Employee Self Welfare, Work Tools Management, Learning and Development, Reports, and Analytics.',
        language: ['HTML', 'Javascript', 'CSS', 'C#', 'MSSQL'],
        ownership: 'Sidmach Technologies',
        github: '',
        dataTarget: '#Waec',
        name: 'Waec',
...

    {
        ...
        language: ['HTML', 'Javascript', 'CSS', 'vb.net', 'MSSQL'],
        ownership: 'Sidmach Technologies',
        github: '#',
        dataTarget: '#e-agric',
        name: 'e-agric',
...

    {
        ...
        language: ['HTML', 'Javascript', 'CSS', 'MSSQL'],
        ownership: 'Sidmach Technologies',
        github: '#',
        dataTarget: '#CinchIT',
        name: 'CinchIT',
...

    {
        ...
        description: 'Build for SDG Cohort-1 Project. My Team attempts to tackle SDG goal 3 (Good Health And Well-being) problem statement 2 - Think of a solution from two perspectives - victim and response side. This solution can help avoid, alert, inform, monitor and report road injuries and deaths (Currently in development stage)',
        language: ['HTML', 'Javascript', 'CSS', 'React', 'node'],
