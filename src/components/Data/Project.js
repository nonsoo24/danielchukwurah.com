...
export const projectList = [
    {
        ...
        language: ['HTML', 'Javascript', 'CSS', 'Bootstrap', 'C#', 'MSSQL'],
    ...
    // },
    {
        ...
        alt:   '',
        link:  '',
        description: 'A mobile application that helps investors grow their money. It allows them invest in Nigeria stocks, Treasury bills, FGN Bonds, Commercial Papers and Afrinvest products. Visit play store to get the app ',
    ...
    },
    {
        ...
        language: ['HTML', 'CSS', 'Tailwind CSS', 'VueJS', 'node', 'mongoDB'],
        ownership: 'Personal',
