...
export const projectList = [
...

    {
        ...
        description: 'An Application that connects accident victims to response units. You could think of it as an ”Uber for accident victims”. Key features include the Help button, Report as an eye witness, Live Feedbacks from Response Teams, a Map view of victims, and response teams.',
